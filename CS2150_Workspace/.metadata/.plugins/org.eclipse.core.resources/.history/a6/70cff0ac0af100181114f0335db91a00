...
public class CS2150Coursework extends GraphicsLab
{
    ...
    // robot list
    private final int robotLegLeft = 3;
    //
    private final int robotLegRight = 4;
    //
    private final int robotBody = 5;
    //
    private final int robotArmLeft = 6;
    //
    private final int robotArmRight = 7;
    //
    private final int robotNeck = 8;
    //
    private final int robotHead = 9;
    ...
    protected void initScene() throws Exception
    {
        ...
        GL11.glEndList();
        //Robot parts
        GL11.glNewList(robotLegLeft, GL11.GL_COMPILE);
        {
        	DrawRobotLegLeft();
        }
        GL11.glEndList();
        GL11.glNewList(robotLegRight, GL11.GL_COMPILE);
        {
        	DrawRobotLegRight();
        }
        GL11.glEndList();
        GL11.glNewList(robotBody, GL11.GL_COMPILE);
        {
        	DrawRobotBody();
        }
        GL11.glEndList();
        GL11.glNewList(robotArmLeft, GL11.GL_COMPILE);
        {
        	DrawRobotArmLeft();
        }
        GL11.glEndList();
        GL11.glNewList(robotArmRight, GL11.GL_COMPILE);
        {
        	DrawRobotArmRight();
        }
        GL11.glEndList();
        GL11.glNewList(robotNeck, GL11.GL_COMPILE);
        {
        	DrawRobotNeck();
        }
        GL11.glEndList();
        GL11.glNewList(robotHead, GL11.GL_COMPILE);
        {
        	DrawRobotHead();
        }
        GL11.glEndList();
